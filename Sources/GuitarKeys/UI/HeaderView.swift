...
struct HeaderView: View {
    ...
    var body: some View {
        ...
        // отступ слева освобождает место под кнопки окна. На весь экран они
        // убираются, и держать под них пустоту незачем.
        .padding(.leading, state.isFullScreen ? 20 : 82)
        .animation(.easeOut(duration: 0.2), value: state.isFullScreen)
        .padding(.trailing, 20)
        .padding(.vertical, 12)
    }
